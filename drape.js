...
function init() {
	...
	var clothTexture = loader.load( "textures/patterns/united-states-of-america_512.png" );
...
//	groundMaterial =	new THREE.ShadowMaterial()
	...
	// ground mesh
	var mesh = new THREE.Mesh( new THREE.PlaneBufferGeometry( 20000, 20000 ), new THREE.ShadowMaterial() );
	mesh.position.y = -250;
	...
	var poleGeo = new THREE.BoxGeometry( 5, 380, 5 );
	poleMat = new THREE.MeshPhongMaterial( { color: 0xffffff, specular: 0x111111,  side: THREE.FrontSide} );
/*
